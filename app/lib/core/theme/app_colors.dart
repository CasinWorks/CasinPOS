...
abstract final class AppColors {
  ...
  /// Restaurant accent (CasinPOS pink).
  static const restaurant = Color(0xFFEC4899);
  static const restaurantSoft = Color(0xFFFCE4EC);

  /// Retail accent (amber on dark).
  ...
  static const tableOccupied = Color(0xFFEC4899);
  ...
  static const catPastry = Color(0xFFFCE4EC);
  ...
  static const goldShimmer = Color(0xFFEAB308);
}
